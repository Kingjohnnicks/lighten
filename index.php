      ...
      <section class="slider_section">
         <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner5.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner6.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner7.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner8.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner9.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner10.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner11.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
               ...
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner12.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
                  ...
                  <img class="third-slide" src="images/banner14.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
                  ...
                  <img class="third-slide" src="images/banner15.png" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Our <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Product </strong></h1>
            ...
            <div class="row">
               <div class="col-md-7 offset-md-3">
                  <div class="title">
                     ...
                     <span>Fastest Sale's & repair service with best price!</span>
                  </div>
               </div>
            </div>
         </div>
...
<!-- end CHOOSE -->
      ...
      <div class="container-fluid padi">
         <div class="map " >
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3946.0152939659392!2d77.54590027382427!3d8.497893097078805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b0443f6e493c5f7%3A0x9bc86e3f89f96e7a!2sFire%20extinguisher%20Gershom%20engineering%20enterprises%20Thirunelveli%20thoothookudi%20tenkasi%20kaniyakumari%20Tamilnadu!5e0!3m2!1sen!2sin!4v1715943933726!5m2!1sen!2sin" width="1270" height="450" style="border: 1px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
         </div>
      </div>
      <!-- end map --> 
      <!--  footer --> 
      ...
      <footr>
         <div class="footer">
            ...
            <div class="copyright">
               <p>Copyright 2019 All Right Reserved By GERSHOM ENGINEERING ENTERPRISES</p>
            </div>
